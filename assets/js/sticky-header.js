...
(function($) {
	...
	class StickyHeaderHandler {
		...
		_setupLogoSwap() {
			...
			// Always apply — Elementor may omit default values from data-settings even
			// with frontend_available:true, so a conditional check would miss them.
			// Hardcoded fallbacks match the control defaults in PHP.
